...
- (DRViewMaker *)maker
{
    DRViewMaker *maker = [DRViewMaker new];
    maker.view = self;
    return maker;
}
...
- (DRLabelMaker *)maker
{
    DRLabelMaker *maker = [DRLabelMaker new];
    maker.view = self;
    return maker;
}
...
- (DRImageViewMaker *)maker
{
    DRImageViewMaker *maker = [DRImageViewMaker new];
    maker.view = self;
    return maker;
}
...
- (DRButtonMaker *)maker
{
    DRButtonMaker *maker = [DRButtonMaker new];
    maker.view = self;
    return maker;
}
...
- (DRTableMaker *)maker
{
    DRTableMaker *maker = [DRTableMaker new];
    maker.view = self;
    return maker;
}
